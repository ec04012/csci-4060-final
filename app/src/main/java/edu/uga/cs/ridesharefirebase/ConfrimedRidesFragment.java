 ...
 * Use the {@link ConfrimedRidesFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ConfrimedRidesFragment extends Fragment {
    ...
    private RecyclerAdapterYourConfrimedRides myAdapter;
    private ArrayList<Ride> rideArrayList;
    private ArrayList<Ride> RequestList;

    public ConfrimedRidesFragment() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        myAdapter = new RecyclerAdapterYourConfrimedRides(getContext(),rideArrayList);
        recyclerView.setAdapter(myAdapter);
        FirebaseUtil.getAllYourConfrimedRides(myAdapter, rideArrayList);
